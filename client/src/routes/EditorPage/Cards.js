...
export const Cards = (props) => {
  return (
    <div class='card-container'>
      ...
      <EditableCard class='card' type='card-mid' initialText={props.midText} title={props.midTitle} backText={props.backCardText} onCardSwitch={props.onCardSwitch} currentCardSide={props.currentCardSide}/>
