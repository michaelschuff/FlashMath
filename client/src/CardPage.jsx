        ...
        <div class="cardpage">
            ...
            <div class="bottom-bar">
                <button class="share-button"> 
                    <img src="https://w7.pngwing.com/pngs/176/664/png-transparent-share-icon-computer-icons-button-button-angle-text-monochrome-thumbnail.png" class="share-icon"></img>
                </button>
            </div>
        </div>
